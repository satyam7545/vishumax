...
export const THEMES: Record<ThemeId, ThemeDefinition> = {
  'design-hub': {
    ...
    accentDark: '#006c4b',
    heroAuraGradient:
      'radial-gradient(ellipse 80% 58% at 50% 10%, rgba(0, 255, 106, 0.7) 0%, rgba(0, 217, 163, 0.42) 42%, rgba(0, 70, 48, 0.16) 68%, transparent 100%)',
    heroDiffusionGradient: 'linear-gradient(to right, transparent, rgba(0, 217, 163, 0.25), transparent)',
    ...
    ctaShadow: '0 8px 32px rgba(0, 255, 106, 0.45)',
  ...
  crimson: {
    ...
    accentDark: '#9b1a0f',
    heroAuraGradient:
      'radial-gradient(ellipse 80% 58% at 50% 10%, rgba(205, 42, 26, 0.75) 0%, rgba(155, 26, 15, 0.45) 42%, rgba(60, 8, 4, 0.16) 68%, transparent 100%)',
    heroDiffusionGradient: 'linear-gradient(to right, transparent, rgba(184, 40, 26, 0.25), transparent)',
    ...
    ctaShadow: '0 8px 30px rgba(235, 68, 46, 0.45)',
  ...
  violet: {
    ...
    accentDark: '#5b21b6',
    heroAuraGradient:
      'radial-gradient(ellipse 80% 58% at 50% 10%, rgba(139, 92, 246, 0.7) 0%, rgba(236, 72, 153, 0.42) 42%, rgba(60, 20, 90, 0.16) 68%, transparent 100%)',
    heroDiffusionGradient: 'linear-gradient(to right, transparent, rgba(139, 92, 246, 0.25), transparent)',
    ...
    ctaShadow: '0 8px 32px rgba(139, 92, 246, 0.45)',
    ctaTextColor: 'text-white',
  ...
  cyan: {
    ...
    accentDark: '#0369a1',
    heroAuraGradient:
      'radial-gradient(ellipse 80% 58% at 50% 10%, rgba(0, 210, 255, 0.7) 0%, rgba(58, 123, 213, 0.42) 42%, rgba(10, 40, 90, 0.16) 68%, transparent 100%)',
    heroDiffusionGradient: 'linear-gradient(to right, transparent, rgba(0, 210, 255, 0.25), transparent)',
    ...
    ctaShadow: '0 8px 32px rgba(0, 210, 255, 0.45)',
    ctaTextColor: 'text-black',
  ...
  amber: {
    ...
    accentDark: '#b45309',
    heroAuraGradient:
      'radial-gradient(ellipse 80% 58% at 50% 10%, rgba(245, 158, 11, 0.75) 0%, rgba(249, 115, 22, 0.45) 42%, rgba(80, 40, 5, 0.16) 68%, transparent 100%)',
    heroDiffusionGradient: 'linear-gradient(to right, transparent, rgba(245, 158, 11, 0.25), transparent)',
    ...
    ctaShadow: '0 8px 32px rgba(245, 158, 11, 0.45)',
    ctaTextColor: 'text-black',
